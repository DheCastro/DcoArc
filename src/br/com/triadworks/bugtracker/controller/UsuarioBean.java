...
public class UsuarioBean {
	...
	public void adiciona(){
		...
		facesUtil.adicionaMensagemDeSucesso("Usuário adicionado com sucesso!");
	}
	...
	public void remove(Usuario usuario){
		dao.remove(usuario);
		this.usuarios = dao.lista(Usuario.class, QuerysGenericas.LISTA_USUARIOS());
		facesUtil.adicionaMensagemDeSucesso("Usuário removido com sucesso!");
	}
	
	public void atualiza(){
		dao.atualiza(this.usuario); 
		facesUtil.adicionaMensagemDeSucesso("Usuário atualizado com sucesso!");
	}
